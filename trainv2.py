...
import random
import os
from utils import CAPTCHA_LIST
...
def main():
    train_image_dir = 'E:/LearnSpider/captcha/img'
    char_set = CAPTCHA_LIST
    model_save_dir = 'E:/LearnSpider/captcha/model'
